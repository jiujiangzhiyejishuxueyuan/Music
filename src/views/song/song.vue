<template>
  <div id="song">
    <div class="song-header" v-if="song">
      ...
      <div class="song-header-inner container flex my-card">
        ...
        <div class="info">
          ...
          <song-control :id="parseInt(id)" :like-ids="likeIds" :btns="btns"/>
        </div>
      </div>
    </div>
    <header-info-ske v-else/>
    <div class="lyric container my-card" v-if="lyrics.length">
      <p class="title">歌词</p>
    ...
    <div class="nolyric text-left container my-card" v-else>纯音乐,请欣赏</div>
    <div class="comment container my-card" ref="comment">
